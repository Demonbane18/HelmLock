...
const char* ssid = "NET_NEUTRALITY"; //Enter your WIFI SSID
const char* password = "Purplecrafters123!"; //Enter your WIFI Password
...
//   if ((char)payload[0] == 'locker1close') {
//     Serial.println("open");
//       for(int angle = 0; angle <= angleMax; angle +=angleStep) {
//         servo1.write(angle);
//         delay(20);
//     }
//   } else if((char)payload[0] == 'locker1open') {
//     Serial.println("close");
//      for(int angle = 180; angle >= angleMin; angle -=angleStep) {
//         servo1.write(angle);
...
//    else if ((char)payload[0] == 'locker2close') {
//     Serial.println("open");
//       for(int angle = 0; angle <= angleMax; angle +=angleStep) {
//         servo2.write(angle);
//         delay(20);
//     }
//   } else if((char)payload[0] == 'locker2open') {
//     Serial.println("close");
//      for(int angle = 180; angle >= angleMin; angle -=angleStep) {
//         servo2.write(angle);
//         Serial.println(angle);
